...
import com.spendsense.exception.UsernameAlreadyExistsException;
import com.spendsense.model.User;
import com.spendsense.repository.RoleRepository;
...
public class UserService {
    ...
    public User register(String username, String password) {
        repository.findByUsername(username)
                .ifPresent(existingUser -> {throw new UsernameAlreadyExistsException(username);});
